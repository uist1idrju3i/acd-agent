...
`vendor/software-agent-sdk`はタグ由来のcommit SHAへ固定する。SDK v1.44.1は
`9d143aac35c2dcec9cbb046ff9f35ac5eb072f6a`であり、ACDから実行時にimportする箇所は
...
`docs/dependency-updates.md`と本書、`AGENTS.md`の版表記を同じ変更で更新する。
