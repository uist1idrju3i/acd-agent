...
> ステータス: Draft  > 対象: プリンテッドエレクトロニクス、ローカル製造、構造エレクトロニクス、個人適合ウェアラブル

本書は、ACDの将来展望とPhase 12以降の製造拡張を扱います。現在の設計フローは
...
家庭の3Dプリンタや卓上CNCは、[Phase 11のローカル製造経路](roadmap.md)としてこれらの
サービスに対応します。

## 現状の技術動向

2026年時点の調査結果です。この表は調査日時点のスナップショットであり、将来の採否や
設計判断の根拠にはしません。価格、在庫、製品状態、性能、リンク先の記載は個別に再確認します。
