...
| 14.14 | 宣言経路解消後の実機実測で残った不足（O-1、O-2、O-4、O-5、O-9〜O-13） | O-1、O-9、O-10、O-11を達成。FWはcapability／device registryとgraph sequenceからpinとcodeを導出し、未宣言peripheralを生成しない。step index、pin role、device、registryはfail-closedで検証し、GD1のGPIO・boot／LED／SHT40出力とaddress macroを維持しつつ、pins logと宣言順初期化を導出する。残るO-2、O-4、O-5、O-12、O-13を扱う。判定と閾値は緩めず、timeout・unknown・未宣言を合格へ倒さない |
