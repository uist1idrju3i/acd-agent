...
| 14.14 | 宣言経路解消後の実機実測で残った不足（O-1、O-2、O-4、O-5、O-9〜O-13） | O-1（`run_tool`のtimeout引数化・`timed_out`区別）とO-9（router pass予算既定の単一定数化）は実装済み。残るO-2、O-4、O-5、O-10〜O-13を扱う。判定と閾値は緩めず、timeout・unknown・未宣言を合格へ倒さない |
