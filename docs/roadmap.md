...
14.1〜14.3、14.6〜14.9は達成済みである。14.7の実測値は
[`vibebb-gap-analysis.md`](vibebb-gap-analysis.md)のE-1〜E-6行と
[`operations.md`](operations.md)を正とする。14.4、14.5および14.6以降の未記載拡張は
14.4、14.5および各行に明記した残存項目は、各ギャップの残存明細に従う。
