...
NETS: dict[str, dict[str, AttrValue]] = {
    ...
    "net.cc1": {"name": "CC1", "voltage_nominal_v": 5.0, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "USB-C logic configuration signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.cc2": {"name": "CC2", "voltage_nominal_v": 5.0, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "USB-C logic configuration signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    ...
    "net.usb_dn": {"name": "USB_D-", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "USB data logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.usb_dp": {"name": "USB_D+", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "USB data logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.en": {"name": "EN", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "Enable logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.boot": {"name": "BOOT", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "Boot logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.led": {"name": "LED", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "LED control logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.led_a": {"name": "LED_A", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "LED current is limited by the series resistor and manufacturing minimum governs this routed net.",},  # noqa: E501
    "net.i2c_sda": {"name": "I2C_SDA", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "I2C logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.i2c_scl": {"name": "I2C_SCL", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "I2C logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.uart_tx": {"name": "UART_TX", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "UART logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
    "net.uart_rx": {"name": "UART_RX", "voltage_nominal_v": 3.3, "width_basis": "manufacturing_minimum", "manufacturing_margin_mm": 0.0, "width_basis_source": "UART logic signal; current-derived capacity is not the controlling constraint.",},  # noqa: E501
}
