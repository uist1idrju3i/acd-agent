/* Firmware projection for golden-design-1; capabilities are graph declarations. */
#include <stdio.h>
#include "acd_pins.h"
...
static const char *TAG = "acd_golden_design_1";
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "pins led=%d i2c_sda=%d i2c_scl=%d", ACD_PIN_LED, ACD_PIN_I2C_SDA, ACD_PIN_I2C_SCL);
