...
- Status: `pass`
- Required subjects: `669`
- Covered subjects: `669`
...
- Subjects: `fab.order_intent.sensor-node`
...
- Attributes: `mcu_component`, `entry_state`
...
- Subjects: `mechanical.enclosure.sensor-node`
- Attributes: `material`, `wall_thickness_mm`
- Decision: Use PETG with a 2.0 mm wall.
- Justification: GD1-REQ-014 requires a board/enclosure shared hole interface; the mechanical lane declares PETG, 2.0 mm wall, and the corresponding clearance/fit gate, so the enclosure projection remains tied to the board interface.
- Rejected alternatives:
  - None recorded: `req.gd1-req-014` and the GD1 mechanical declaration fix the shared enclosure interface and PETG/2.0 mm lane for this fixture.
...
- Subjects: `mechanical.enclosure.sensor-node`
- Attributes: `min_wall_thickness_mm`, `internal_clearance_mm`, `standoff_height_mm`, `standoff_radius_mm`, `lid_fit_gap_mm`, `tolerance_mm`, `interference_tolerance_mm3`
- Decision: Use 1.2 mm minimum wall, 1.0 mm internal clearance, 4.0 mm standoff height with 2.0 mm radius, 0.2 mm lid gap, 0.05 mm tolerance, and 0.01 mm3 interference limit.
- Justification: §8.1/§9 define 1.2 mm minimum wall, 1.0 mm component clearance, 4.0 mm standoff height with 2.0 mm radius, 0.2 mm lid gap, 0.05 mm CAD tolerance, and 0.01 mm3 interference threshold. These values leave measurable assembly room while still failing actual collision.
- Rejected alternatives:
...
- Subjects: `mechanical.outline.sensor-node`
