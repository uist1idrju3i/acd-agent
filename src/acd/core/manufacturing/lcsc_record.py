...
def check_declared_mpn(identity: LcscRecordIdentity, *, declared_mpn: str | None) -> LcscMpnCheck:
...
def check_declared_lcsc(identity: LcscRecordIdentity, *, declared_lcsc: str | None) -> LcscMpnCheck:
