...
class FabProfile:
    ...
    def preference_rule_ids(self) -> frozenset[str]:
        return frozenset(preference["rule_id"] for preference in self.data["preferences"])
...
def resolve_fab_profile_path(profile_id: str, registry: FabProfileRegistry | None = None) -> Path:
