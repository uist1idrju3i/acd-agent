...
from acd.core.knowledge.rationale import RationaleRefreshError, refresh_rationale_document
...
def commit_candidate_graph(
    ...
    try:
        ...
        raise CandidateCommitError(f"accepted candidate could not be written: {exc}") from exc
    return {
