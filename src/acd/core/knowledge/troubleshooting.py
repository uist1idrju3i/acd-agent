...
def _macro_expectation(
    ...
    return (
        TroubleshootingExpectation(description=description, expected=value, citation=citation),
        None,
    )
    ...
    entries = [
        ...
        _entry(
            ...
            resolved=[
                ...
                _macro_expectation(pin_macros, "ACD_SHT40_I2C_ADDRESS", "Sensor I2C address"),
            ],
        ),
        _entry(
            ...
            resolved=[
                ...
                _macro_expectation(pin_macros, "ACD_LOG_PERIOD_MS", "Log period in milliseconds"),
            ],
        ),
        _entry(
