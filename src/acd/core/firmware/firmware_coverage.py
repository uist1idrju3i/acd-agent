...
def check_firmware_coverage(
    ...
    capability_by_action = {
        action: capability for capability in registry.capabilities for action in capability.actions
    }
    ...
    consumed_roles = set(registry.pin_role_order) | {
        role for capability in used_capabilities.values() for role in capability.required_pin_roles
    }
